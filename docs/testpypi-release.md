...
```bash
git tag testpypi-v0.2.1rc1
git push origin testpypi-v0.2.1rc1
```
...
```bash
python -m venv /tmp/mlip-lsp-testpypi
/tmp/mlip-lsp-testpypi/bin/python -m pip install --upgrade pip
/tmp/mlip-lsp-testpypi/bin/pip install \
